...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      {/* Popup Box */}
      {isOpen && (
        <div className="mb-4 w-72 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden transition-all duration-300">
          <div className="bg-emerald-600 p-4 text-white flex justify-between items-center">
            <div>
              <h4 className="font-bold text-sm">Chat with Us</h4>
              <p className="text-xs text-emerald-100">Usually replies in a few minutes</p>
            </div>
            <button 
      ...
      <button
        ...
        className="bg-emerald-500 hover:bg-emerald-600 text-white p-4 rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110"

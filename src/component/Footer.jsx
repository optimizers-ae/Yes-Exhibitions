      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 pb-12 sm:pb-14 border-b border-gray-200/90">
          ...
          <motion.div
            ...
            className="col-span-2 sm:col-span-2 md:col-span-4 lg:col-span-4 space-y-4 sm:space-y-6"
          >
            <a href="/" className="flex items-center gap-3 group min-w-0 inline-flex">
            ...
            <p className="text-xs sm:text-sm text-gray-600 leading-relaxed max-w-sm">
              Premier turnkey exhibition stand design & fabrication contractor. Delivering bespoke trade show experiences across the UAE, Middle East, and worldwide venues.
            </p>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={fadeUpVariants}
            className="col-span-2 sm:col-span-1 md:col-span-1 lg:col-span-2 space-y-4 sm:space-y-5"
          >
            <div>
              <h4 className="text-xs sm:text-sm font-bold text-gray-900 tracking-wider uppercase">
                Industries
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={fadeUpVariants}
            className="col-span-2 sm:col-span-2 md:col-span-1 lg:col-span-2 space-y-4 sm:space-y-5"
          >
            <div>
              <h4 className="text-xs sm:text-sm font-bold text-gray-900 tracking-wider uppercase">
                Contact Info
            ...
            <ul className="space-y-3 sm:space-y-3.5 text-xs sm:text-sm">
              ...
              <li className="flex items-start gap-3 group">
                ...
                <span className="leading-snug text-gray-600">
                  YES Exhibition Stands, Dubai World Trade Centre, UAE
                </span>
              </li>
              ...
              <li className="flex items-center gap-3 group min-w-0">
                <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#D49942]/10 border border-[#D49942]/20 flex items-center justify-center shrink-0 group-hover:bg-[#D49942] transition-colors">
                  <Globe className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#D49942] group-hover:text-white transition-colors" />
                </span>
                <a
                  href="https://yesexhibitionstands.com"
                  target="_blank"
                  rel="noreferrer"
                  className="hover:text-gray-950 transition-colors text-gray-600 font-medium inline-flex items-center gap-1"
                >
                  <span>yesexhibitionstands.com</span>
                  <ArrowUpRight className="w-3 h-3 text-gray-400 group-hover:text-[#D49942] transition-colors" />
                </a>
              </li>
            </ul>
          </motion.div>
